    ...
    <>
      {open && (
        <>
          ...
          <div className="fixed inset-x-0 top-20 bottom-0 z-50 lg:hidden bg-white/95 backdrop-blur-2xl border-b border-gray-200/60 shadow-2xl overflow-y-auto">
      ...
      <header className="fixed top-0 w-full z-[60] bg-white/80 backdrop-blur-2xl border-b border-gray-200/60 shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center h-20 px-5">
          ...
          <nav className="flex items-center">
            ...
            <button
              className="lg:hidden relative z-[70] ml-2 flex items-center justify-center w-11 h-11 rounded-xl bg-gray-100 hover:bg-gray-200 transition-colors active:scale-95"
