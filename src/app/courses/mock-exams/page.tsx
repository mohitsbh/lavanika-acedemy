...
export default function MockExamsPage() {
  const courses = courseDetails.filter(c => c.category === "Mock Exams")

  return (
    <div className="pt-28 pb-20 px-5 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <Badge variant="default" className="mb-4">MOCK EXAMS</Badge>
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Mock Exams</h1>
        <p className="text-lg text-on-surface-variant max-w-2xl mx-auto">
          Simulate full ADC Clinical and Technical day exams under timed conditions with detailed feedback to improve station strategy and time management.
        </p>
      </div>
          ...
          <div key={i} className="glass rounded-3xl overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="flex items-center gap-3 pt-1">
                ...
                <Link href="/courses/mock-exams/comparison" className="text-sm text-primary hover:underline">
                  Compare courses
                </Link>
              </div>
            </div>
      ...
      <div className="glass rounded-3xl p-8 md:p-12 text-center space-y-4">
        <h2 className="text-2xl font-semibold text-on-surface">Ready to test your skills under exam conditions?</h2>
        <p className="text-on-surface-variant max-w-xl mx-auto">Get personalised feedback and performance analysis to identify your strengths and areas for improvement.</p>
