...
export default function OthersPage() {
  const courses = courseDetails.filter(c => c.category === "Others")

  return (
    <div className="pt-28 pb-20 px-5 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <Badge variant="default" className="mb-4">OTHER SERVICES</Badge>
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Other Services</h1>
        <p className="text-lg text-on-surface-variant max-w-2xl mx-auto">
          Flexible, à la carte options to complement your ADC preparation — including supervised and unsupervised practice sessions, chair hire, online task assessment, and task demos.
        </p>
      </div>
          ...
          <div key={i} className="glass rounded-3xl overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            <div className="aspect-[16/9] overflow-hidden bg-primary/5 flex items-center justify-center">
              {course.image ? (
                ...
                <div className="text-on-surface-variant/30 text-sm">No image available</div>
              )}
            </div>
            <div className="p-6 space-y-3">
              ...
              <div className="flex items-center gap-3 pt-1">
                ...
                <Link href="/courses/others/comparison" className="text-sm text-primary hover:underline">
                  Compare courses
                </Link>
              </div>
            </div>
      ...
      <div className="glass rounded-3xl p-8 md:p-12 text-center space-y-4">
        <h2 className="text-2xl font-semibold text-on-surface">Need a flexible option for your preparation?</h2>
        <p className="text-on-surface-variant max-w-xl mx-auto">From practice sessions to chair hire, we have flexible options to suit your schedule and learning needs.</p>
