...
export const metadata: Metadata = {
  title: "Compare Skilled OSCE Courses",
  description: "Compare Skilled OSCE course options — beginner and refresher packages for ADC preparation.",
}

const category = "Skilled OSCE"
  ...
  return (
    <div className="pt-28 pb-20 px-5 max-w-7xl mx-auto">
      ...
      <p className="text-on-surface-variant mb-10 max-w-2xl">
        Choose between our beginner and refresher Skilled OSCE packages based on your experience level.
      </p>
