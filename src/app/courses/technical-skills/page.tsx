...
export default function TechnicalSkillsPage() {
  const courses = courseDetails.filter(c => c.category === "Technical Skills")

  return (
    <div className="pt-28 pb-20 px-5 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <Badge variant="default" className="mb-4">TECHNICAL SKILLS</Badge>
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Technical Skills Courses</h1>
        <p className="text-lg text-on-surface-variant max-w-2xl mx-auto">
          Hands-on training for ADC technical stations — composite, amalgam, provisional, crown cutting, caries, endo, and infection control. Build precision, speed, and efficiency under real exam conditions.
        </p>
      </div>
          ...
          <div key={i} className="glass rounded-3xl overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="flex items-center gap-3 pt-1">
                ...
                <Link href="/courses/technical-skills/comparison" className="text-sm text-primary hover:underline">
                  Compare courses
                </Link>
              </div>
            </div>
      ...
      <div className="glass rounded-3xl p-8 md:p-12 text-center space-y-4">
        <h2 className="text-2xl font-semibold text-on-surface">Ready to refine your technical skills?</h2>
        <p className="text-on-surface-variant max-w-xl mx-auto">Get expert coaching and hands-on practice to build exam-ready precision and speed.</p>
