...
export default function HealthPage() {
  return (
    <div className="pt-20">
      <PageHeader
        badge="CAMPUS HEALTH &amp; WELLNESS"
        title={<>Health &amp; <span className="text-primary">Infirmary</span></>}
        description="A comprehensive healthcare facility dedicated to the physical and mental well-being of the Lavanika Academy community."
      />
      <SectionWrapper>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <GlassCard className="col-span-1 md:col-span-2 lg:col-span-1" contentClassName="p-0 space-y-4">
          ...
          <GlassCard className="bg-error-container/10 border-error/20" contentClassName="p-0 space-y-4">
          ...
          <GlassCard contentClassName="p-0 space-y-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <GlassCard key={i} className="text-center" contentClassName="p-0 space-y-3">
